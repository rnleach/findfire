...
enum Satellite {
    SATFIRE_G16,                            /**< GOES-16, formerly GOES-R. */
    SATFIRE_G17,                            /**< GOES-17, formerly GOES-S. */
    SATFIRE_NUM_SATS,                       /**< The number of satellites in the enumeration. */
    SATFIRE_NO_SATELLITE = SATFIRE_NUM_SATS /**< Used as an error code. */
};
 ...
 *
 * \returns Satellite that corresponds to the first satellite name found, or SATFIRE_NO_SATELLITE
 * if none was found.
 */
